<!-- Include Header -->
<?php include "wiki_php/include/header.php" ?>

<!-- Include Navbar -->
<?php include "wiki_php/include/navbar.php" ?>
    
<!-- Include Hidden side div -->
   <?php include "wiki_php/include/side_div.php" ?>

    <!-- Intro Section -->
    <section id="franklin" class="section">        
        <div class="container intro_header">
        ...
        <div class="title_div">            
            ...
            <div class="subject_title">
                <h2>January 17, 1706 - April 17, 1790</h2>
                <h1>Benjamin Franklin</h1>
                <h3><em>"An investment in knowledge pays the best interest."</em></h3>
            </div>
            
            <div class="subject_title">
                <img class="img-thumbnail img-circle" src="../img/bfranklin_thumb.png" width="350px">
            </div>            
        </div>
    ...
    <!-- About Section -->
    <section id="ancestry" class="section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="section_title">Ancestry</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="early-life" class="section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="section_title">Early Life in Boston</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Contact Section -->
    <section id="philadelphia" class="section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="section_title">Philadelphia</h1>
                </div>
            </div>
        </div>
    </section>
